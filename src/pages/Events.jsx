  ...
  return (
    <div style={S.calScroll}>
      {monthPairs.map(([leftMonth, rightMonth]) => (
        <div key={leftMonth} style={S.monthRow}>
...
function MonthView({ year, month, events, onDayClick, onEventClick }) {
  ...
  return (
    <div style={{ ...S.calScroll, padding: "0 24px 24px" }}>
...
function WeekView({ baseDate, events, onEventClick, onDayClick }) {
  ...
  return (
    <div style={{ ...S.calScroll, flexDirection: "column" }}>
...
function ListView({ events, onEventClick }) {
  ...
  return (
    <div style={{ ...S.calScroll, padding: "20px 24px", flexDirection: "column", gap: 0 }}>
  ...
  return (
    <div style={S.app}>
      <aside style={S.sidebar}>
        <button onClick={() => navigate(-1)} className="text-white bg-teal">
          <ArrowLeft />
        </button>
        <button
        ...
        <p className="font-bold" style={S.hint}>
      ...
      <main style={S.main}>
        <div className="bg-teal-700" style={S.topBar}>
          ...
          <div style={{ fontWeight: 800, fontSize: 17, color: "white", minWidth: 260, textAlign: "center" }}>{navLabel()}</div>
...
const S = {
  ...
  modal: { background: "#fff", borderRadius: 16, width: 520, maxWidth: "95vw", boxShadow: "0 20px 60px rgba(109,90,255,0.2)", overflow: "hidden" },
