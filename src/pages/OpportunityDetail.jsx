...
function EditOpportunityModal({ open, opportunity, stages, saving, onClose, onSave }) {
  ...
  const submit = () => {
    ...
    onSave({
      ...
      domainItemId: opportunity.domainItemId || null,
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <div className="md:col-span-2">
            <div className="mb-2 flex items-center justify-between gap-3">
              <span className="text-xs font-semibold uppercase tracking-wide text-gray-500">Industry Details</span>
...
export default function OpportunityDetail() {
  ...
  const loadDetail = useCallback(async () => {
    ...
    try {
      ...
      const [stageResponse, emailResponse, appointmentResponse] = await Promise.all([
        api.get(
  ...
  const scheduleAppointment = async (event) => {
    event.preventDefault();
    if (!opportunity || !appointmentForm.startAt) return;
    setMessage("");
    try {
            ...
            <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
              <div className="min-w-0">
                ...
                <div className="mt-3 flex flex-wrap items-center gap-x-5 gap-y-2 text-sm text-gray-500">
                  ...
                  {opportunity.industryKey && <span>{industryLabel(opportunity.industryKey)}</span>}
            ...
            <div>
              ...
              <div className="flex flex-col gap-3 rounded-lg border border-gray-100 bg-slate-50 p-4 md:flex-row md:items-center md:justify-between">
                <div className="flex flex-wrap items-center gap-2">
                  <select value={stageValue} onChange={(event) => setStageValue(event.target.value)} className="h-10 rounded-lg border border-gray-300 bg-white px-3 text-sm">
          ...
          <main className="space-y-6">
            ...
            {domainItem && (
              <section className="rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
                ...
                <div className="mt-4 grid gap-4 md:grid-cols-2">
                  ...
                  <Info label="Industry" value={domainItem.industryKey} />
                ...
                {Object.entries(parseMetadata(domainItem.metadataJson)).length > 0 && (
                  <div className="mt-4 grid gap-3 md:grid-cols-2">
                    {Object.entries(parseMetadata(domainItem.metadataJson))
            ...
            <section id="appointments" className="scroll-mt-6 rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
              ...
              <form onSubmit={scheduleAppointment} className="grid gap-3 rounded-lg border border-gray-100 bg-slate-50 p-4 md:grid-cols-2">
                ...
                <div className="md:col-span-2">
                  <button disabled={!appointmentForm.startAt} className="rounded-lg bg-teal-700 px-4 py-2 text-sm font-semibold text-white hover:bg-teal-800 disabled:opacity-60">
            ...
            <section id="timeline" className="scroll-mt-6 rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
              <h2 className="text-lg font-bold text-gray-950">Contact Timeline</h2>
              <div className="mt-4 space-y-3">
                ...
                {timeline.length === 0 && <p className="rounded-lg border border-dashed border-gray-200 p-6 text-center text-sm text-gray-500">No contact activity yet.</p>}
              </div>
            </section>
          </main>
