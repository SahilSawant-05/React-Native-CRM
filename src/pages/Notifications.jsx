...
export default function Notifications() {
  ...
  return (
    <main className="min-h-screen bg-slate-50 p-6 text-gray-900">
          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 rounded-lg bg-teal-700 px-4 py-2 text-sm font-semibold text-white hover:bg-teal-800 disabled:cursor-not-allowed disabled:opacity-50"
              >
...
function NotificationRow({ notification, onOpen, onToggleRead }) {
  ...
  return (
    <article className={`group px-5 py-4 transition hover:bg-slate-50 ${unread ? "bg-teal-50/50" : "bg-white"}`}>
      <div className="flex gap-4">
        ...
        <button
          ...
          className="h-fit rounded-lg border border-gray-300 px-3 py-2 text-xs font-bold text-gray-700 opacity-100 hover:bg-white sm:opacity-0 sm:group-hover:opacity-100"
        >
