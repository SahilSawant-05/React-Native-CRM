...
export function SettingsTabs({ activeTab, items, onChange }) {
  return (
    <div className="mb-6 flex max-w-full gap-1 overflow-x-auto border-b border-gray-200 sm:flex-wrap sm:gap-2">
      {items.map(({ key, label, icon: Icon }) => {
        ...
        return (
          <button
            ...
            className={`inline-flex min-h-11 shrink-0 items-center gap-2 border-b-2 px-3 py-3 text-sm font-semibold transition sm:px-4 ${
              active
