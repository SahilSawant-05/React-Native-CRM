...
export default function Users() {
  ...
  const createUser = async (e) => {
    ...
    try {
      ...
      const message = errorMessage(err, "Failed to create user");
  ...
  return (
    <div className="users-page" style={{ minHeight: "100vh", background: "#f8fafc", padding: 24, fontFamily: "'DM Sans', sans-serif" }}>
      <div className="users-container" style={{ maxWidth: 1280, margin: "0 auto", display: "grid", gap: 24 }}>
        <div>
        ...
        <div className="users-layout" style={{ display: "grid", gridTemplateColumns: "minmax(320px, 420px) minmax(0, 1fr)", gap: 24, alignItems: "start" }}>
          <form
          ...
          <div style={{ display: "grid", gap: 16 }}>
            <div style={{ background: "#fff", borderRadius: 20, padding: 18, border: "1px solid #e2e8f0", boxShadow: "0 18px 50px rgba(15, 23, 42, 0.05)" }}>
              <div className="users-list-header" style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 12, flexWrap: "wrap" }}>
                <div>
              ...
              filteredUsers.map((user) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="user-card-actions" style={{ display: "flex", gap: 10, flexWrap: "wrap", alignItems: "center" }}>
                      <select
