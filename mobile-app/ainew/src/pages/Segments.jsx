...
const labelFor = (value) => leadSourceLabel(value);
...
export default function Segments() {
  ...
  return (
    <div className="segments-page" style={{ minHeight: "100vh", background: "#f8fafc", padding: "24px", fontFamily: "'DM Sans', sans-serif" }}>
      <div style={{ maxWidth: 1280, margin: "0 auto", display: "grid", gap: 24 }}>
        ...
        <div className="segments-layout" style={{ display: "grid", gridTemplateColumns: "minmax(320px, 420px) minmax(0, 1fr)", gap: 24, alignItems: "start" }}>
          <form
            ...
            <div style={{ display: "grid", gap: 14 }}>
              ...
              <div style={{ display: "grid", gap: 10 }}>
                ...
                {visibleFilterKeys.map((key) => (
                  <div key={key} className="segment-filter-row" style={{ display: "grid", gridTemplateColumns: "150px minmax(0, 1fr) auto", gap: 8, alignItems: "center" }}>
