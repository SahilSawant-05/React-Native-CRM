...
const FALLBACK_STAGES: StageMeta[] = [
  ...
  { key: "FOLLOW_UP", label: "Follow Up", color: "#7c3aed", icon: "📅" },
  { key: "WON",       label: "Won",       color: "#059669", icon: "🏆" },
  { key: "LOST",      label: "Lost",      color: "#dc2626", icon: "❌" },
];
...
const lms = StyleSheet.create({
  ...
  input:      { backgroundColor: "#f8fafc", borderWidth: 1, borderColor: "#e2e8f0", borderRadius: 10, padding: 12, fontSize: 14, color: "#1e293b", minHeight: 90, textAlignVertical: "top", marginBottom: 16 },
  btnRow:     { flexDirection: "row", gap: 10 },
  cancelBtn:  { flex: 1, paddingVertical: 13, alignItems: "center", borderRadius: 10, borderWidth: 1, borderColor: "#e2e8f0" },
  cancelText: { fontSize: 14, fontWeight: "600", color: "#64748b" },
  confirmBtn: { flex: 1, paddingVertical: 13, alignItems: "center", borderRadius: 10, backgroundColor: "#dc2626" },
...
const dm = StyleSheet.create({
  root:        { flex: 1, backgroundColor: "#f8fafc" },
  header:      { flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingHorizontal: 16, paddingVertical: 14, backgroundColor: "#fff", borderBottomWidth: 1, borderBottomColor: "#f1f5f9" },
  title:       { fontSize: 15, fontWeight: "800", color: "#0f172a", flex: 1, textAlign: "center", marginHorizontal: 8 },
  closeText:   { fontSize: 15, color: "#64748b", fontWeight: "600" },
